...
# Politique de confidentialité - Plus fraîche ma ville
...
dans le cadre de l’activité du site Plus fraîche ma ville (ci-après le « Site »).
...
Plus fraîche ma ville traite des données à caractère personnel notamment pour : 
-   Permettre la connexion des agents ou élus de collectivités aux espaces projets ;
-   Gérer et diffuser la lettre d’information ;
-   Gérer les inscriptions aux webinaires ; 
-   Piloter la relation utilisateurs via un CRM ;
-   Recevoir les demandes de contact des utilisateurs ;
-   Suivre l’état d’avancement des projets en cours, le taux d’utilisation de l’espace projet.
...
<div class="fr-table fr-table--no-caption" data-fr-js-table="true"><table data-fr-js-table-element="true" class=""><caption data-fr-js-table-caption="true">Caption tableau des sous-traitants</caption><thead><tr><th scope="col">Partenaire</th><th scope="col">Pays destinataire</th><th scope="col">Pays d'hébergement</th><th scope="col">Traitement réalisé</th><th scope="col">Garantie</th></tr></thead><tbody><tr><td>Scalingo</td><td>France</td><td>France</td><td>Hébergement</td><td><a href="https://scalingo.com/fr/contrat-gestion-traitements-donnees-personnelles" rel="noopener noreferrer" target="_blank">https://scalingo.com/fr/contrat-gestion-traitements-donnees-personnelles</a></td></tr><tr><td>Squadra</td><td>France</td><td>France</td><td>Agent conversationnel</td><td><a href="https://www.squadra.ai/" rel="noopener noreferrer" target="_blank">https://www.squadra.ai/</a></td></tr><tr><td>Hubspot</td><td>Allemagne</td><td>France</td><td>Gestion du CRM et mesure d'audience</td><td><a href="https://legal.hubspot.com/dpa" rel="noopener noreferrer" target="_blank">https://legal.hubspot.com/dpa</a></td></tr><tr><td>Brevo</td><td>France</td><td>France</td><td>Gestion et diffusion de la lettre d'information</td><td><a href="https://www.brevo.com/fr/legal/termsofuse/#accord-sur-le-traitement-des-donnees-a-caractere-personnel-dpa" rel="noopener noreferrer" target="_blank">https://www.brevo.com/fr/legal/termsofuse/#accord-sur-le-traitement-des-donnees-a-caractere-personnel-dpa</a></td></tr><tr><td>Matomo</td><td>France</td><td>France</td><td>Mesure d'audience</td><td><a href="https://fr.matomo.org/privacy-policy/" rel="noopener noreferrer" target="_blank">https://fr.matomo.org/privacy-policy/</a></td></tr></tbody></table></div>

### 7.2 Cookies

<div class="fr-table fr-table--no-caption" data-fr-js-table="true"><table data-fr-js-table-element="true" class=""><caption data-fr-js-table-caption="true">Caption tableau des cookies</caption><thead><tr><th scope="col">Catégorie de cookie</th><th scope="col">Nom du cookie</th><th scope="col">Durée de conservation</th><th scope="col">Finalités</th><th scope="col">Éditeur</th><th scope="col">Destination</th></tr></thead><tbody><tr><td>Authentification</td><td>Next-Auth</td><td>1 mois</td><td>Gestion de l'authentification dans l'espace projet</td><td>Next Auth &amp; ADEME</td><td>France</td></tr><tr><td>Mesure d’audience anonymisée</td><td>Matomo</td><td>13 mois</td><td>Mesure d’audience</td><td>Matomo &amp; ADEME</td><td>France</td></tr><tr><td>Mesure d’audience</td><td>Hubspot</td><td>13 mois</td><td>Mesure d’audience des utilisateurs connectés</td><td>Hubspot</td><td>Allemagne</td></tr></tbody></table></div>
