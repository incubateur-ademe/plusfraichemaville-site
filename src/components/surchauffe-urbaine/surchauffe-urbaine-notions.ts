export const SURCHAUFFE_URBAINE_NOTIONS = [
  {
    code: "notion-icu",
    ...
    description:
      ...
      "émissions de chaleur humaine. Mesurer l’ICU, c’est mieux comprendre où la chaleur s’accumule en ville et " +
      "identifier les endroits où agir en priorité.",
  },
  {
    code: "notion-confort-thermique",
    image: "/images/surchauffe-urbaine/surchauffe-notions-confort-thermique.svg",
