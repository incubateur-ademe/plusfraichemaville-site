...
export default function RetourExperienceCard({
  ...
  let url = projetId
    ? PFMV_ROUTES.ESPACE_PROJET_FICHES_SOLUTIONS_REX(+projetId, retourExperience.attributes.slug)
    : `${PFMV_ROUTES.RETOURS_EXPERIENCE}/${retourExperience.attributes.slug}`;
