...
export const climadiagIndicateursData = {
  line: {
    jours_chauds: {
      ...
      legend: (seuil: number) => ({
        2030: [
          `Un jour est considéré comme très chaud si la température dépasse ${seuil} °C au cours de la journée.`,
    ...
    nuits_chaudes: {
      ...
      legend: (seuil: number) => ({
        2030: [
          `Une nuit est considérée comme chaude si la température durant cette nuit ne descend pas en dessous de ${seuil} °C.`,
