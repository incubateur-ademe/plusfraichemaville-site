        ...
        <div>
          <div className="mb-2">
            <span className="flex items-center justify-between">
              Email : <CopyIcon text={contact.email} field="Email" />
            </span>
            <span className="block cursor-pointer text-pfmv-navy" onClick={() => handleCopy(contact.email, "Email")}>
              {contact.email}
            </span>
          </div>
          <div className="mb-2">
            <span className="flex items-center justify-between">
              Téléphone : <CopyIcon text={contact.telephone} field="Téléphone" />
            </span>
            <span className="block cursor-pointer" onClick={() => handleCopy(contact.telephone, "Téléphone")}>
              {contact.telephone}
            </span>
          </div>
        </div>
