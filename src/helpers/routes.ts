...
export const PFMV_ROUTES = {
  ...
  ESPACE_PROJET_FICHES_SOLUTIONS_LISTE_TOUTES_SOLUTIONS: (projetId: number) =>
    `/espace-projet/${projetId}/fiche-solution/liste/toutes-solutions`,
  ESPACE_PROJET_FICHES_SOLUTIONS_LISTE_TOUTES_SOLUTIONS_SUFFIX: "/fiche-solution/liste/toutes-solutions",
...
export const SEARCH_AIDE_FOR_PROJET_URL = (
  ...
  }&updateUnselectedFs=${updateUnselectedFs}`;
