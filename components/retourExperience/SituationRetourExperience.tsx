...
import { DirectusFiles } from "@/lib/directus/directusModels";

export default async function SituationRetourExperience({
  titre,
  texte,
  image,
  className,
      ...
      <div className="fr-card__header">
        <div className="fr-card__img">
          <Image
            ...
            src={DIRECTUS_ASSET_URL + image + "?key=fiche-technique-card"}
            alt={titre}
          />
        </div>
      </div>
