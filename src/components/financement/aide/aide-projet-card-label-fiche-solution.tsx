...
export const AideProjetCardLabelFicheSolution = ({ ficheId }: { ficheId: string }) => {
  ...
  const iconTypeSolution =
    getTypeSolutionFromCode(ficheSolution?.type_solution)?.coloredIcon("fr-icon--sm mr-1") ?? null;
