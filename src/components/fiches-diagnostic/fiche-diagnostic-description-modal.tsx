...
export const FicheDiagnosticDescriptionModal = () => {
  ...
  const utiliteFiche =
    currentFicheDiagnostic?.overrideUtiliteFiche ?? (ficheDiagnostic && getFicheDiagUtilite(ficheDiagnostic));
    ...
    <>
      <modal.Component
        ...
        className={clsx(
          ...
          utiliteFiche === FicheDiagnosticUtilite.ConfortThermique ? "confort-thermique-modal" : "icu-modal",
        )}
      >
