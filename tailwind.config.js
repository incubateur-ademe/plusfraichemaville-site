...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      "background-fiche-diag-icu": "#FFC5B1",
      "text-confort-thermique": "#FC5D00",
      "picto-highlight-diag-icu": "#EB754B",
      "picto-faded-diag-icu": "#F59C74",
      "picto-highlight-confort-thermique": "#DA9006",
      "picto-faded-confort-thermique": "#EDB610",
      "border-diag-icu": "#FC5D00",
      "border-confort-thermique": "#E3AE0E",
      "coeff-permeabilite": "var(--background-action-high-info-hover)",
      "coeff-rafraichissement-urbain": "var(--background-active-blue-france)",
      "coeff-biodiversite": "#29A31E",
      "coeff-canopee": "#78719E",
    },
  },
  plugins: [],
};
